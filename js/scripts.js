$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Megan and Daryl's Wedding",

      // Event start date
      start: new Date("Sep 23, 2023 14:00"),
      ...
      end: new Date("Sep 24, 2017 02:00"),

      // Event Address
      address: "Lakeside Hotel, Ballina, Co. Tipperary",

      // Event Description
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact Daryl (+353833112055) or Megan (+353879336743).",
    },
  });
...
var countDownDate = new Date("Sep 23, 2023 14:00:00").getTime();
